...
export default function ContactSection() {
  return (
    <section className="bg-[#F7F5F0] text-[#111111] py-24 md:py-40 px-6 md:px-12 w-full" id="contact">
      <div className="max-w-[1600px] mx-auto text-center flex flex-col items-center">
        
        <div className="flex items-center gap-3 mb-8">
          <span className="w-8 h-[1px] bg-[#FF4E1F]"></span>
          <span className="text-[#FF4E1F] font-bold text-[10px] tracking-widest uppercase">04</span>
          <span className="w-8 h-[1px] bg-[#FF4E1F]"></span>
        </div>
        ...
        <WhatsAppButton 
          label="Chat with us"
          className="bg-[#FF4E1F] text-[#F7F5F0] px-10 py-5 rounded-[10px] font-black text-sm tracking-widest uppercase hover:bg-[#111111] transition-colors shadow-lg inline-flex items-center justify-center gap-3 group"
        />
