    ...
    <section className="bg-[#F4F1EB] text-[#111111] pt-16 md:pt-24 lg:pt-36 xl:pt-48 pb-16 md:pb-24 px-4 md:px-8 lg:px-10 w-full overflow-hidden" id="collections" data-navbar-theme="light">
      <div className="max-w-[1500px] mx-auto">
        ...
        <div className="flex items-center gap-4 mb-10 md:mb-16">
          ...
          <h2 className="font-bold text-[10px] md:text-xs lg:text-sm tracking-[0.2em] uppercase text-[#111111]/85 m-0">
            Collections
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8 xl:gap-10">
          ...
          <div className="md:col-span-2 xl:col-span-2 relative h-[450px] md:h-[500px] flex flex-col justify-center lg:justify-start lg:pt-10 group z-10 border border-transparent">
            ...
            <h2 className="font-oswald font-bold text-[55px] md:text-[85px] lg:text-[90px] xl:text-[105px] leading-[0.85] uppercase tracking-[-0.02em] relative z-20 mt-4 text-[#111111] scale-y-[1.25] origin-left w-2/3 md:w-full">
              <div className="block">CURATED</div>
              <div className="flex items-end">
                <span>FOR <span className="text-[#C8321F]">YOU</span></span>
                <span className="inline-block w-[14px] h-[14px] md:w-[18px] md:h-[18px] lg:w-[22px] lg:h-[22px] bg-[#C8321F] ml-3 mb-[12px] lg:mb-[16px] scale-y-[0.8]" aria-hidden="true"></span>
              </div>
            </h2>
            
            <div className="mt-12 md:mt-16 max-w-[200px] md:max-w-[280px] relative z-20">
              <p className="text-[13px] md:text-[15px] font-medium text-black/90 mb-8 leading-relaxed">
            ...
            <div className="hidden lg:block absolute left-[-20px] top-[15%] w-[1px] h-[60%] bg-black/10 z-0" aria-hidden="true" />
            <div className="hidden lg:block absolute left-[-20px] top-[20%] w-[12px] h-[1px] bg-black/10 z-0" aria-hidden="true" />
            <div className="hidden lg:block absolute left-[-8px] top-[10%] w-[1px] h-[40px] bg-black/10 rotate-45 z-0" aria-hidden="true" />
          </div>
