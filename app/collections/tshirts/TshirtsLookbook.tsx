...
export default function TshirtsLookbook() {
  ...
  const nextShirt = () => {
    handleIndexChange((activeIndex + 1) % tshirtsData.length);
  };

  const prevShirt = () => {
    handleIndexChange((activeIndex - 1 + tshirtsData.length) % tshirtsData.length);
  };
      ...
      <div className="max-w-[1700px] mx-auto w-full px-6 md:px-12 flex flex-col flex-1 relative">
        ...
        <div className="flex-1 flex flex-col md:flex-row relative z-10 w-full h-full">
          ...
          <div className="w-full md:w-[55%] lg:w-[60%] flex flex-col relative order-1 md:order-2">
            ...
            <div className="w-full flex-1 relative min-h-[500px] md:min-h-0 flex items-center justify-center p-4 lg:p-8">
